...
<body>
  <div class="main main-signup">
    <p class="sign" align="center">Sign up</p>
    <form class="form1">
      <input class="un " type="text" align="center" placeholder="Username" id="userName">
      <input class="un " type="text" align="center" placeholder="Dog name" id="dogName">
      <input class="un " type="text" align="center" placeholder="Breed" id="breed">
